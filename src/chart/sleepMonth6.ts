import { getRandomNumber, getOrCreateTooltipKruz, getRandom, monthArray, month6, sleepYtime, awakeColor, remColor, coreColor, deepColor } from './global_label'
  ...
  datasets: [
    {
      ...
      borderRadius: 6,
      data: getRandom(month6.length ,1, 1),
      borderSkipped: true,
    },
    {
      label: 'Deep',
      ...
      borderRadius: 6,
      data: getRandom(month6.length ,0, 8),
      borderSkipped: true,
    },
    {
      label: 'Core',
      backgroundColor: coreColor,
      borderRadius: 6,
      data: getRandom(month6.length ,0, 5),
      borderSkipped: true,
    },
    {
      label: 'Deep',
    ...
    },
    {
      ...
      backgroundColor: remColor,
      borderRadius: 6,
      data: getRandom(month6.length ,0, 7),
      borderSkipped: true,
    },

    {
      ...
      backgroundColor: remColor,
      borderRadius: 6,
      data: getRandom(month6.length ,-1, 8),
      borderSkipped: true,
    },
    {
      label: 'Awake',
    ...
    },
    {
      ...
      backgroundColor: remColor,
      borderRadius: 6,
      data: getRandom(month6.length ,-1, 5),
      borderSkipped: true,
    },
    {
      label: 'Core',
      backgroundColor: coreColor,
      borderRadius: 6,
      data: getRandom(month6.length ,-2, 8),
      borderSkipped: true,
    },
    {
      label: 'REM',
    ...
    },
    {
      ...
      backgroundColor: coreColor,
      borderRadius: 6,
      data: getRandom(month6.length ,-3, 8),
      borderSkipped: true,
    },
    {
      label: 'Deep',
    ...
    },
    {
      ...
      backgroundColor: coreColor,
      borderRadius: 6,
      data: getRandom(month6.length ,-1, 4),
      borderSkipped: true,
    },
    {
      label: 'REM',
    ...
    },
    {
      ...
      backgroundColor: coreColor,
      borderRadius: 6,
      data: getRandom(month6.length ,-3, 5),
      borderSkipped: true,
    },
